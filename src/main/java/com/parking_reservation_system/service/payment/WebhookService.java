...
public class WebhookService {
    ...
    public void processPaymentCallback(Map<String, Object> payload) {
        ...
        String subType =
                String.valueOf(((Map) obj.get("source_data")).get("sub_type")).toUpperCase();
        ...
        else if (Boolean.parseBoolean(obj.get("is_refunded").toString()))
        ...
        key.setResponse_body(
                getNeededDataFromPayload(payload, reservationId, idempotencyKey).toString());
        key.setResponse_code(200);
        key.setStatus("COMPLETED");
        idempotencyKeyRepository.save(key);
    }

    public JSONObject getNeededDataFromPayload(
            Map<String, Object> responseMap, int reservation_id, UUID IdempotencyKey) {
